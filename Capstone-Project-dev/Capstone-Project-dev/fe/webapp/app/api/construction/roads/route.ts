import { createRoad, getAllRoads } from "@/services/construction.service";
...
export async function GET(req: NextRequest) {
  try {
    ...
    return NextResponse.json(
      {
        message: "Lấy danh sách đường phố thành công",
...
export async function POST(req: NextRequest) {
  try {
    ...
    const response = await createRoad(accessToken, name);
